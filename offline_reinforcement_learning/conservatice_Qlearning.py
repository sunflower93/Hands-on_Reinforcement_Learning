...
from SAC.SACContinuous import PolicyNetContinuous, QValueNetContinuous
...
class CQL:
    ...
    def soft_update(self, net, taeget_net):
        for param_target, param in zip(taeget_net.parameters(), net.parameters()):
    ...
    def update(self, transition_dict):
        ...
        q2_cat = torch.cat([q1_unif - random_unif_log_pi, q1_curr - random_curr_log_pi.detach().view(-1, self.num_random, 1),  q1_next - random_next_log_pi.detach().view(-1, self.num_random, 1)], dim=1)
