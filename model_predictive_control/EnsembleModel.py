...
class FCLayer(torch.nn.Module):
    def __init__(self, input_dim, output_dim, ensembel_size, activation):
        super(FCLayer, self).__init__()
        self._input_dim, _output_dim = input_dim, output_dim
        self.weight = torch.nn.Parameter(torch.Tensor(ensembel_size, input_dim, output_dim).to(device))
        self._activation = activation
        self.bias = torch.nn.Parameter(torch.Tensor(ensembel_size, output_dim).to(device))
